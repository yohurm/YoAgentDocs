...
| [架构审查](instructions/prompts/tasks/architecture-review.md) | 审查架构/质量、硬编码、补丁层、兼容层、越级、MVVM、数据链路、高内聚、文件单一职责、API 里写了实现 | 该任务 |
...
| 审查 List 有没有补丁、兼容层和越级 | 架构审查 |
| API 文件里写了绘制/手势，或 import 了 internal | 架构审查 |
